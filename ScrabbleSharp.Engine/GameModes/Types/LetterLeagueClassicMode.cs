...
/// <summary>
///     Defines the configuration for the Letter League Classic game mode.
/// </summary>
public sealed class LetterLeagueClassicMode : IGameMode
{
    /// <inheritdoc />
    public GameMode Id => GameMode.LetterLeagueClassic;

    /// <inheritdoc />
    public IGameRules Rules { get; } = new LetterLeagueClassicRules();

    /// <inheritdoc />
    public WordList Dictionary => WordList.Wordnik;

    /// <inheritdoc />
    public IBoardLayout CreateLayout(IServiceProvider services)
        => services.GetRequiredService<LetterLeagueLayout>();
}